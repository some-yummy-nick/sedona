(function() {
  ...
  toggler.addEventListener("click", function() {
    document.querySelector(".menu").classList.toggle("menu--hide-block");
    document.querySelector(".header").classList.toggle("header--toggle");
    document.querySelector(".toggle__icon").classList.toggle("toggle__icon--block-menu");
    document.querySelector(".toggle__iconclose").classList.toggle("toggle__iconclose--hide-menu");
  });
